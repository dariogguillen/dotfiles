...
# ln -sf /media/data/Documents ~/
# ln -sf /media/data/Downloads ~/
# ln -sf /media/data/Music ~/
# ln -sf /media/data/Pictures ~/
# ln -sf /media/data/Public ~/
# ln -sf /media/data/Templates ~/
# ln -sf /media/data/Videos ~/
